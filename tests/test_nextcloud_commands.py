...
class TestNextcloudCommands(unittest.TestCase):
    ...
    def test_print_first_class_docstring(self):
        nc_command = NextcloudCommands("activities")
        nc_command.get_first_class = MagicMock(return_value=MagicMock(__name__="TestClass", __doc__="Test docstring."))
        nc_command.print_first_class_docstring()

    def test_print_method_docstring(self):
        nc_command = NextcloudCommands("activities")
        nc_command.get_first_class = MagicMock(return_value=MagicMock(test_method=MagicMock(__doc__="Test method docstring.")))

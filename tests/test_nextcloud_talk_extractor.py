...
class TestNextcloudTalkExtractor(unittest.TestCase):
    def setUp(self):
        ...
        self.talk_extractor = NextcloudTalkExtractor(self.base_url, self.username, self.password, self.room_id)
    ...
    def test_get_conversations_ids(self):
        ...
        self.talk_extractor.nextcloud_requests.send_request = MagicMock(return_value=mock_response)

        conversations = self.talk_extractor.get_conversations_ids()
        self.assertEqual(conversations, {"Test Room": "12345678", "Another Room": "87654321"})
    ...
    def test_get_messages(self):
        ...
        messages = self.talk_extractor.get_messages(self.room_id, message_limit=2)

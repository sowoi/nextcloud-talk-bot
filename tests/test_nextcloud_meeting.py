...
class TestNextcloudMeeting(unittest.TestCase):
    ...
    def test_create_room(self, mock_nextcloud_requests,
                         mock_nextcloud_talk_extractor):
        """
    ...
    @patch("nextcloud_talk_bot.nextcloud_meeting.NextcloudTalkExtractor")
    @patch("nextcloud_talk_bot.nextcloud_meeting.NextcloudRequests")
    def test_delete_room(self, mock_nextcloud_requests,
                         mock_nextcloud_talk_extractor):
        """
        ...
        with patch("builtins.input", return_value="yes"):
            ...
            mock_nextcloud_requests.delete_request.assert_called_with(
                "/ocs/v2.php/apps/spreed/api/v4/room/12345")

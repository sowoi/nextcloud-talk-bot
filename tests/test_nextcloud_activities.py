...
class TestNextcloudActivities(unittest.TestCase):
    ...
    def test_get_last_activities(self):
        ...
        with patch("nextcloud_talk_bot.nextcloud_activities.NextcloudRequests") as MockNextcloudRequests:
            ...
            nextcloud_activities = NextcloudActivities("https://example.com", "username", "password")
    ...
    def test_search_last_activities(self):
        ...
        with patch("nextcloud_talk_bot.nextcloud_activities.NextcloudRequests") as MockNextcloudRequests:
            nextcloud_activities = NextcloudActivities("https://example.com", "username", "password")
            nextcloud_activities.get_last_activities = Mock(return_value=activities)
            result = nextcloud_activities.search_last_activities(activity="event")

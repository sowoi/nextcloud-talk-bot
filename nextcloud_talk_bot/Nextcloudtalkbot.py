...
class NextcloudTalkBot:
    def __init__(self, base_url=None, username=None, password=None, room_name=None, room_token=None):
        self._data = None
        ...
        self.activities = NextcloudActivities(**self.config["nextcloud_base_data"])
        self.file = NextcloudFileOperations(**self.config["nextcloud_base_data"])
        self.extractor = NextcloudTalkExtractor(**self.config["nextcloud_base_data"])
        self.user = NextcloudUser(**self.config["nextcloud_base_data"])
        self.meeting = NextcloudMeeting(**self.config["nextcloud_base_data"])
        self.poll = NextcloudPoll(**self.config["nextcloud_base_data_with_room_name"])
        self.messages = NextcloudMessages(**self.config["nextcloud_base_data_with_room_token"])

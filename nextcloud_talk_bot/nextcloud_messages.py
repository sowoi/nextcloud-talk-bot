...
class NextcloudMessages:
    ...
    def delete_message_in_nextcloud_talk_group(self, message_id=None):
        ...
        if message_id == None:
            last_messages_dict = NextcloudMessages.receive_messages_of_nextcloud_talk_group(self, message_limit=10)
            ...
            print(f"You have selected the following message:: {selected_message[1]}")

...
class NextcloudPoll:
    ...
    def __init__(self, base_url, username, password, room_name, room_token=None, question=None, voting_options=None, max_votes=1, result_mode=0, poll_id=None):
    ...
    def create_poll(self, question=None, voting_options=None, max_votes=1, result_mode=0):
        ...
        endpoint = f"/ocs/v2.php/apps/spreed/api/v1/poll/{self.room_token}"
